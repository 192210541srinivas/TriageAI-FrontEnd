...
import com.simats.triageai.databinding.ItemNonUrgentCaseNewBinding
import com.simats.triageai.models.Patient

class NonUrgentCasesNewAdapter(
    private var patients: List<Patient>
) : RecyclerView.Adapter<NonUrgentCasesNewAdapter.ViewHolder>() {

    class ViewHolder(val binding: ItemNonUrgentCaseNewBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemNonUrgentCaseNewBinding.inflate(LayoutInflater.from(parent.context), parent, false)

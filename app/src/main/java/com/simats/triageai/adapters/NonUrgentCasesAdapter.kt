...
import com.simats.triageai.databinding.ItemNonUrgentCaseBinding
import com.simats.triageai.models.Patient

class NonUrgentCasesAdapter(
    private var patients: List<Patient>
) : RecyclerView.Adapter<NonUrgentCasesAdapter.ViewHolder>() {

    class ViewHolder(val binding: ItemNonUrgentCaseBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemNonUrgentCaseBinding.inflate(LayoutInflater.from(parent.context), parent, false)

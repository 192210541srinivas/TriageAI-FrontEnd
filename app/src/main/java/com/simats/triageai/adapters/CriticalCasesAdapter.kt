...
import com.simats.triageai.databinding.ItemCriticalCaseBinding
import com.simats.triageai.models.Patient

class CriticalCasesAdapter(
    private var patients: List<Patient>
) : RecyclerView.Adapter<CriticalCasesAdapter.ViewHolder>() {

    class ViewHolder(val binding: ItemCriticalCaseBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemCriticalCaseBinding.inflate(LayoutInflater.from(parent.context), parent, false)

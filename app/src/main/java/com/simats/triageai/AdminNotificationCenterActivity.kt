...
import com.simats.triageai.databinding.ActivityAdminNotificationCenterBinding
import com.simats.triageai.models.Notification
import kotlinx.coroutines.launch

class AdminNotificationCenterActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAdminNotificationCenterBinding
    private lateinit var adapter: NotificationAdapter
    private var notifications = mutableListOf<Notification>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAdminNotificationCenterBinding.inflate(layoutInflater)
    ...
    private fun fetchNotifications() {
        ...
        lifecycleScope.launch {
            try {
                ...
                binding.progressBar.visibility = View.GONE
                Toast.makeText(this@AdminNotificationCenterActivity, "Error fetching notifications", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun markAllAsRead() {
        ...
        lifecycleScope.launch {
            try {
                ...
                Toast.makeText(this@AdminNotificationCenterActivity, "Error updating status", Toast.LENGTH_SHORT).show()
            }
        }
    }

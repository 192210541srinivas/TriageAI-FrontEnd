...
import com.simats.triageai.databinding.ActivityNonUrgentResultBinding

class NonUrgentResultActivity : AppCompatActivity() {

    private lateinit var binding: ActivityNonUrgentResultBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityNonUrgentResultBinding.inflate(layoutInflater)
